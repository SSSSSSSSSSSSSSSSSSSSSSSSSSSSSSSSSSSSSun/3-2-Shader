...
void Digit()
{
    FragColor = texture(u_DigitTextureLoc, v_UV);
}
...
void Digit_Num()
{
    ...
    FragColor = texture(u_NumTextureLoc, vec2(tx, ty));
}

void Digit_Num_FourDigits_NoIf()
{
